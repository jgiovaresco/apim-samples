...
dependencyResolutionManagement {
  versionCatalogs {
    create("libs") {
      ...
      version("avro", "1.12.0")
      version("confluent", "7.9.2")
      version("kotlin-faker", "1.16.0")
      version("grpc", "1.75.0")
      version("junit", "5.13.4")
      version("kotlin", "2.2.20")
      version("logback", "1.5.18")
      version("mutiny-clients", "3.20.0")
      version("protobuf", "4.32.1")
      version("quarkus", "3.28.0")
      ...
      plugin("axion", "pl.allegro.tech.build.axion-release").version("1.20.1")
